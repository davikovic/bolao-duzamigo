...
import { Plus, Trophy, Info, AlignLeft, Hash } from "lucide-react";
...
export function PoolsTab({ pools }: PoolsTabProps) {
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {pools.map((pool) => (
          <div key={pool.id} className="bg-[#121212] border border-white/5 p-8 rounded-[2.5rem] transition-all hover:border-white/10 group">
